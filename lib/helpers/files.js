  ...
  S['qDownloadUrl'] = function(options, callback){
    ...
    , function(cb){
        FS.stat(gb.path, function(err, stat){
          ...
          if (a.o.retry_until_complete && gb.file_content_length !== gb.request_content_length){
            if (a.o.retry >= a.o.retry_until_complete) return cb(new Error('File length mismatch - downloading'));
