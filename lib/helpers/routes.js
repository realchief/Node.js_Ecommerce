...
/*        _.extend(gb.query, {
  ...
  S.instance.express.all('/products/list.json', function(req, res){

  });

  S.instance.express.all('/media/list.json', function(req, res){
...
///////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  S.instance.express.all('/set/:set', function(req, res, next){
    ...
    , function(cb){
        ...
        gb.doc.media = gb.doc.media.slice(0, 50);
        gb.doc.products = gb.doc.products.slice(0, 50);
