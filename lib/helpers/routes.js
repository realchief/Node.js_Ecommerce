...
////////////////////////////////////////////////////////////////////////////////
  ...
  S.instance.express.all('/list/media', function(req, res, next){
    var a = {
      'o': _.extend({}, {
             'data': req.data()
           , 'session': req.session
    ...
    Async.waterfall([
      ...
      , 'docs': gb.docs || []
      , 'title': 'WANDERSET'
      , 'page_title': a.o.data.page_title || false
      , 'js_files': [
  ...
  S.instance.express.all('/list/product', function(req, res, next){
    var a = {
      'o': _.extend({}, {
             'data': req.data()
           , 'session': req.session
