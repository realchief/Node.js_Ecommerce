...
/*        _.extend(gb.query, {
  ...
  if (S.settings.environment !== 'production'){
    S.instance.express.all('*', function(req, res, next){
      ...
      //if (!is_admin) return res.redirect(301, 'https://wanderset.com' + req.originalUrl);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  S.instance.express.all('/brands', function(req, res){
    ...
    var html = S.instance.renderView(req, 'brands', {
      'docs': _.filter(S.instance.brand_logo_sets, function(b){
        return Belt.get(b, 'filtered_products.length') >= 4;
      })
    , 'title': 'WANDERSET'
    });
