...
module.exports = function(S){
  ...
  S['UpdateProduct'] = function(options, callback){
    ...
    , function(cb){
        ...
        , 'description': {
            'us': gb.doc.get('description.us') || a.o.product.body_html
          }
        , 'vendor': a.o.vendor.get('_id')
        , 'brands': [
            a.o.vendor.get('name')
        ...
        */
        ...
        if (!a.o.product.published_at) gb.doc.set({
          'hide': true
        });
  ...
  S.instance.express.all('/hub/shopify/:shop/authorize.json', function(req, res){
    ...
    , 'shopify_scope': false && req.params.shop.match(/completely/i) ? 'read_products' : 'read_products,read_orders,write_orders,read_shipping,read_price_rules'
