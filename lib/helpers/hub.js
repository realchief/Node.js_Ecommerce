  ...
  S['UpdateShopifyProduct'] = function(options, callback){
    ...
    Async.waterfall([
      function(cb){
        ...
        if (Belt.call(a.o.product, 'tags.match', /women|woman|female|girl/i)) return cb(new Error('Product is for women'));
        if (Belt.call(a.o.product, 'handle', /\_hers/i)) return cb(new Error('Product is for women'));
    ...
    , function(cb){
        ...
        , 'label': {
            'us': Str.stripTags(a.o.product.title)
          }
        , 'description': {
