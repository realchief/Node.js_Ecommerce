...
module.exports = function(S){
  ...
  if (S.settings.environment === 'development' || S.settings.environment === 'production-worker'){
  ...
  if (S.settings.environment === 'development' || S.settings.environment === 'production-worker') S.instance.on('ready', function(){
    Async.forever(function(next){
