...
module.exports = function(S){
  ...
  S['GetOrderMetrics'] = function(options, callback){
    ...
    , 'vendor_payments_dkk': self.instance.priceString(_.reduce(a.o.docs, function(m, d){
        return m + _.reduce(d.vendor_orders, function(m2, v){
          return m2 + _.reduce(v, function(m3, v2){
            var tot;
    ...
    , 'discount_revenue_rate': (gb.data.discount_expenses / gb.data.revenue).toFixed(1)
    ...
    , 'aov'
      ...
      gb.data[v] = S.instance.priceString(gb.data[v]);
    })
