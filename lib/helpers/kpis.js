...
module.exports = function(S){
  S['proxy_host'] = 'http://localhost:9008';
  ...
  if (S.settings.environment === 'production'){
    S.instance.express.use('/admin/kpis/orders/from/:from/to/:to/read.json', Proxy(S.proxy_host));

    S.instance.express.use('/admin/kpis/orders/from/:from/to/:to/email.json', Proxy(S.proxy_host));
