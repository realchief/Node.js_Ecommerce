...
module.exports = function(S){
  S['LoadProductCategories'] = function(options, callback){
    ...
    , function(cb){
        ...
        if (a.o.set_instance) self.instance['categories'] = gb.categories;
  ...
  S['LoadProductOptionsWithExamples'] = function(options, callback){
          ...
          S.instance.db.model('product').find({}).skip(skip).limit(limit).exec(function(err, docs){
            ...
            _.each(docs, function(d){
              _.each(d.options, function(o){
                ...
                gb.options[l] = {
                  'values': gb.options[l].values || {}
                , 'skus': gb.options[l].skus || []
                };
                ...
                _.each(vals, function(v){
                  ...
                  if (gb.options[l].values[v] < a.o.example_count) gb.options[l].values[v].push(d.slug);
                });
              });
            });
    ...
    , function(cb){
        self.instance['product_options_with_examples'] = gb.options;
