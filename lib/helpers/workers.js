...
module.exports = function(S){
  ...
  if (S.settings.environment !== 'staging-development' && S.settings.environment !== 'staging' && S.settings.environment !== 'development' && S.settings.environment !== 'production') S.instance.on('ready', function(){
    Async.forever(function(next){
