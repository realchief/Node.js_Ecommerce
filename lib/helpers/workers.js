    ...
    Async.forever(function(next){
      ...
      , function(cb){
          Async.eachSeries(S.instance.vendors, function(e, cb2){
            key = 'kpis:product:vendor-' + e._id.toString();
...
/*                '$or': [
                  {
                    'brands': S.instance.escapeRegExp(e.name, 'i')
                  }
                , {
                    'manual_brand': S.instance.escapeRegExp(e.name, 'i')
                  }
                ]*/
              })
            }, function(err, data){
          ...
          Async.eachSeries(S.instance.all_categories, function(e, cb2){
            ...
            S.instance.helpers.kpis.SummarizeProducts({
              'query': _.extend({}, {
                '$or': [
                  {
                    'categories': S.instance.escapeRegExp('^' + e, 'i')
                  }
                , {
                    'auto_category': S.instance.escapeRegExp('^' + e, 'i')
                  }
                ]
              })
            }, function(err, data){
...
/*
  if (S.settings.environment === 'development' || S.settings.environment === 'production-worker-8') S.instance.on('ready', function(){
    Async.forever(function(next){
