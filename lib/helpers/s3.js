...
module.exports = function(S){
  ...
  S['UploadPath'] = function(options, callback){
    ...
    a.o = _.defaults(a.o, {
      ...
      //image_metadata
      //image_shrink
      'content_type': a.o.mime || (Mime.lookup ? Mime.lookup(a.o.s3_path) : Mime.getType(a.o.s3_path))
    ...
    , function(cb){
      ...
      if (a.o.remove_path){
        if (gb.orig_path) FS.unlink(gb.orig_path, Belt.np);
        FS.unlink(a.o.path, Belt.np);
      }
