...
module.exports = function(Opts, Instance){
  ...
  M.method('getStocks', function(options, callback){
    ...
    M.Instance.db.model('stock').find({
  ...
  M.method('toSanitizedObject', function(options, callback){
    ...
    _.extend(obj, {
      'vendor': self.get('vendor._id') ? self.get('vendor').toSanitizedObject(a.o) : obj.vendor
    , 'stocks': _.map(self.get('stocks'), function(s){
