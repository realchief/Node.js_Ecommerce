...
module.exports = function(Opts, Instance){
  ...
  MediaSchema.virtual('downsample').get(function(){
  ...
  MediaSchema.method('uploadDownsampleS3', function(options, callback){
    ...
    a.o = _.defaults(a.o, {
      's3_path': O.name + '/media-' + self.get('_id').toString() + '.downsample.' + (a.o.filename || a.o.path || a.o.url.replace(/(\?|#).*$/g, '')).split('.').pop()
    });
    a.o = _.defaults(a.o, {
      'mime': Mime.lookup(a.o.s3_path)
    });
  ...
  M.method('getOptionConfigurations', function(options, callback){
    ...
    return _.object(Instance.arrayCombinations(_.values(obj)));
  });
