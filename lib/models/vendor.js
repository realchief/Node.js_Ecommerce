...
module.exports = function(Opts, Instance){
  ...
  M.pre('save', function(next){
    if (_.any(this.get('contact_emails'))){
      this.set({
        'contact_emails': _.map(this.get('contact_emails'), function(e){
  ...
  M.method('toCSVObject', function(options, callback){
    ...
    var obj = self.toSanitizedObject(a.o);
    delete obj.shipping_options;

    obj = Belt.objFlatten(obj);
