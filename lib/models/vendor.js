...
module.exports = function(Opts, Instance){
  ...
  , 'shipping_description': Instance.helpers.internationalization.LocalitySchemaObject()
  , 'returns_description': Instance.helpers.internationalization.LocalitySchemaObject()
  , 'setmembers': [
