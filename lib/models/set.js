...
module.exports = function(Opts, Instance){
  ...
  M.method('uploadS3', function(options, callback){
    ...
    a.o = _.defaults(a.o, {
      's3_path': O.name + '/' + a.o.prefix + self.get('_id').toString() + '.jpg' //+ (a.o.filename || a.o.path || a.o.url.replace(/(\?|#).*$/g, '')).split('.').pop()
    });
    a.o = _.defaults(a.o, {
  ...
  M.method('uploadDownsampleS3', function(options, callback){
    ...
    a.o = _.defaults(a.o, {
      's3_path': O.name + '/' + a.o.prefix + self.get('_id').toString() + '.downsample.jpg'
    });
    a.o = _.defaults(a.o, {
      'mime': Mime.lookup(a.o.s3_path)
    });
  ...
  M.method('uploadSuperDownsampleS3', function(options, callback){
    ...
    a.o = _.defaults(a.o, {
      's3_path': O.name + '/' + a.o.prefix + self.get('_id').toString() + '.super.downsample.jpg'
    });
    a.o = _.defaults(a.o, {
      'mime': Mime.lookup(a.o.s3_path)
    });
