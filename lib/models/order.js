      ...
      gb.order = _.mapObject(gb.magento_vendors, function(v, k) {
        return _.extend(Belt.copy(gb.order), {
          'cart_items': _.map(v, function (v2) {
            ...
            var custom_options = [];
            _.each(Belt.get(v2, 'source.stock.options'), function (v3) {
              ...
              var custom_option = {
                  ...
                  , 'option_value': matching_option_value.option_type_id || matching_option_value.value_index
              };
            ...
            var cart_item = {
              'sku': Belt.get(v2, 'source.product.source.record.sku')
              , 'qty': v2.quantity
              // , 'variant_id': Belt.get(v2, 'source.stock.source.record.id')
              , 'product_option': {
