...
module.exports = function(S){
  ...
  /**
   * @api {post} /admin/promo_code/create.json Create PromoCode
  ...
  /**
   * @api {get} /admin/promo_code/:_id/read.json Read PromoCode
   ...
   */
    S.instance.express.get('/admin/' + S.name + '/:_id/read.json', function(req, res){
      ...
      , function(cb){
          if (!gb.doc) return cb(new Error('promo_code not found'));
  ...
  /**
   * @api {put} /promo_code/:_id/update.json Update PromoCode
  ...
  /**
   * @api {delete} /admin/promo_code/:_id/delete.json Delete PromoCode
  ...
  /**
   * @api {get} /admin/promo_code/list.json List PromoCodes
  ...
  /**
   * @api {get} /admin/promo_code/count.json Count PromoCode
