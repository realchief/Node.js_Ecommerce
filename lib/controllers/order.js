...
module.exports = function(S){
   ...
   */
   ...
   /**
     * @api {post} /order/:_id/product:/:prod/update.json Update Product Stock
     * @apiName UpdateProduct
     * @apiGroup Order
     * @apiPermission admin
     *
   */
    S.instance.express.post('/admin/' + S.name + '/:_id/product/:old_prod/product/:new_prod/update.json', function(req, res){
      var a = {
        'o': _.extend({}, {
               'data': req.data()
             , 'session': req.session
