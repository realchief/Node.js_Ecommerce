...
*/
  ...
  if ((true || S.settings.environment === 'production-worker') && Belt.get(S.settings, 'notifications.new_order_slack')){
    S.instance.on('ready', function(){
      Async.forever(function(next){
        var gb = {};
        ...
        , function(cb){
            gb['today_total'] = _.reduce(gb.docs, function(m, n){
              return m + n.get('total_price');
            }, 0) || 0;

            gb['today_count'] = Belt.get(gb.docs, 'length') || 0;
        ...
        , function(cb){
            gb['yesterday_total'] = _.reduce(gb.docs, function(m, n){
              return m + n.get('total_price');
            }, 0) || 0;

            gb['yesterday_count'] = Belt.get(gb.docs, 'length') || 0;
        ...
        , function(cb){
            gb['yesterday_cum_total'] = _.reduce(gb.docs, function(m, n){
              return m + n.get('total_price');
            }, 0) || 0;

            gb['yesterday_cum_count'] = Belt.get(gb.docs, 'length') || 0;
        ...
        , function(cb){
            gb['last_week_total'] = _.reduce(gb.docs, function(m, n){
              return m + n.get('total_price');
            }, 0) || 0;

            gb['last_week_count'] = Belt.get(gb.docs, 'length') || 0;
        ...
        , function(cb){
            gb['last_week_cum_total'] = _.reduce(gb.docs, function(m, n){
              return m + n.get('total_price');
            }, 0) || 0;

            gb['last_week_cum_count'] = Belt.get(gb.docs, 'length') || 0;
        ...
        , function(cb){
            ...
            , 'body': {
                'text': '*SALES*\nToday: $'
                        ...
                        + '\nvs. Yesterday count: ' + (((gb.today_count / gb.yesterday_cum_count) - 1) * 100).toFixed(0) + '% (' + gb.yesterday_cum_count + ')'
                        + '\nvs. Last ' + Moment().format('dddd') + ' this time: ' + (((gb.today_count / gb.last_week_count) - 1) * 100).toFixed(0) + '% (' + gb.last_week_count + ')'
                        + '\nvs. Last ' + Moment().format('dddd') + ' count: ' + (((gb.today_count / gb.last_week_cum_count) - 1) * 100).toFixed(0) + '% (' + gb.last_week_cum_count + ')'
          ...
          if (err) S.instance.ErrorNotification(err, 'DailySalesTotal', {
