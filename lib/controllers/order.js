...
module.exports = function(S){
  ...
  if (S.settings.environment === 'production') S.instance.on('ready', function(){
    S.model.findOne({
      ...
      doc.products[0].source.order = {
        'order': {
          'id': 91825438749
        }
      };

      doc.products[1].source.order = {
        'order': {
          'id': 91825438749
        }
      };

      doc.products[2].source.order = {
        'order': {
          'id': 5569964242
        }
      };

      doc.products[3].source.order = {
        'order': {
          'id': 6277806604
        }
      };

      doc.products[4].source.order = {
        'order': {
          'id': 6277806604
        }
      };

      doc.products[7].source.order = {
        'order': {
          'id': 6145225479
        }
      };
