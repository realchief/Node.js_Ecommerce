    ...
    S.instance.on('ready', function(){
      Async.forever(function(next){
        ...
        , function(cb){
            S.model.find({
              'created_at': {
                '$lt': Moment().year(Moment().year()).month(Moment().month()).date(1).hours(0).minutes(0).seconds(0).milliseconds(0).toDate()
              }
            }, Belt.cs(cb, gb, 'docs', 1, 0));
          }
        , function(cb){
        ...
        , function(cb){
            ...
            , 'body': {
                'text': '*SALES*\nToday: $'
                        ...
                        + '\n***\n'
                        + 'MTD: $' + gb.this_month_total.toFixed(2)
                        + '\n***\n'
                        + '*ORDERS*\nToday: '
                        + gb.today_count
                        ...
                        + '\n***\n'
                        + 'MTD: $' + gb.this_month_aov.toFixed(2)
                        + '\n***\n'
                        + '*UNIT COUNT*\nToday: '
                        + gb.today_unit_count
