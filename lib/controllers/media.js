   ...
   */
    S.instance.express.post('/' + S.name + '/create.json', function(req, res){
      ...
      return Async.waterfall([
        ...
        if (err) S.instance.emit('error', err, 'CreateMedia' + (gb.doc ? ' - ' + Belt.get(gb.doc, '_id.toString()') : ''));
   ...
   */
    S.instance.express.get('/' + S.name + '/:_id/read.json', function(req, res){
      ...
      , function(cb){
        ...
        if (err) S.instance.emit('error', err, 'ReadMedia' + ' - ' + req.params._id);
   ...
   */
    S.instance.express.all('/' + S.name + '/:_id/update.json', function(req, res){
      ...
      , function(cb){
        ...
        if (err) S.instance.emit('error', err, 'UpdateMedia' + (gb.doc ? ' - ' + Belt.get(gb.doc, '_id.toString()') : ''));
   ...
   */
    S.instance.express.delete('/' + S.name + '/:_id/delete.json', function(req, res){
      ...
      , function(cb){
        ...
        if (err) S.instance.emit('error', err, 'DeleteMedia' + (gb.doc ? ' - ' + Belt.get(gb.doc, '_id.toString()') : ''));
