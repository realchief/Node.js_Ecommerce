...
module.exports = function(S){
  ...
  /**
   * @api {put} /set/:_id/featured_media/create.json Add Featured Media to Set
   * @apiName CreateSetFeaturedMedia
   * @apiGroup Set
   * @apiPermission admin, current setmember user
   *
   */
  ...
  /**
   * @api {delete} /set/:_id/featured_media/delete.json Delete Featured Media from Set
   * @apiName DeleteSetFeaturedMedia
   * @apiGroup Set
   * @apiPermission admin, current setmember user
   *
   */
