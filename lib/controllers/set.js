...
*/
   ...
   */
    ...
    S.instance.express.all('/admin/' + S.name + '/:_id/product/:product/add.json', function(req, res){
      var a = {
        'o': _.extend({}, {
               'data': req.data()
             , 'session': req.session
    ...
    S.instance.express.all('/admin/' + S.name + '/:_id/product/:product/remove.json', function(req, res){
      var a = {
        'o': _.extend({}, {
               'data': req.data()
             , 'session': req.session
    ...
    S.instance.express.all('/admin/' + S.name + '/:_id/media/:media/add.json', function(req, res){
      var a = {
        'o': _.extend({}, {
               'data': req.data()
             , 'session': req.session
    ...
    S.instance.express.all('/admin/' + S.name + '/:_id/media/:media/remove.json', function(req, res){
      var a = {
        'o': _.extend({}, {
               'data': req.data()
             , 'session': req.session
